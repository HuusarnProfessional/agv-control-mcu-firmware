...
{
    constexpr std::int16_t k_mission_linear_speed_mm_s = 220;
    ...
    constexpr double k_mission_heading_p_yaw_rate_mdeg_s_per_deg = 700.0;
    constexpr double k_mission_lookahead_mm = 140.0;
