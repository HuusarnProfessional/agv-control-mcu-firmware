...
{
    constexpr std::int16_t k_mission_linear_speed_mm_s = 120;
    ...
    constexpr double k_mission_goal_tolerance_mm = 150.0;
    constexpr double k_mission_speed_slowdown_heading_error_deg = 20.0;
    constexpr double k_mission_turn_only_heading_error_deg = 40.0;
    ...
    constexpr std::uint16_t k_mission_max_closest_segment_checks = 64u;
    constexpr double k_mission_max_closest_progress_advance_mm = 1200.0;
    constexpr std::uint16_t k_mission_max_lookahead_segment_steps = 64u;
    constexpr std::uint32_t k_mission_pose_hold_time_ms = 400U;
    constexpr std::uint32_t k_mission_pose_jump_guard_window_ms = 1000U;
    constexpr double k_mission_pose_jump_base_margin_mm = 350.0;
    constexpr double k_mission_pose_jump_speed_mm_s = 2000.0;
