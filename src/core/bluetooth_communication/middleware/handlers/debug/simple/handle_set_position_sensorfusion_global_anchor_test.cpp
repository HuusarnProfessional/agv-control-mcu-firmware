...
namespace debug_handlers
{
    bool handle_set_position_sensorfusion_global_anchor_test()
    {
        ...
        position_sensorfusion_pipeline::set_global_anchor_test_mode(enabled);

        if (enabled == true)
        {
            return handler_helpers::write_response_text("position_sensorfusion_global_anchor_test enabled");
        }

        return handler_helpers::write_response_text("position_sensorfusion_global_anchor_test disabled");
    }
}
