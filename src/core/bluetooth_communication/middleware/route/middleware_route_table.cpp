...
namespace
{
    ...
    const middleware_route_types::middleware_command_route g_debug_routes[] =
    {
        ...
        {"get_global_reference_selector_debug()", debug_handlers::handle_get_global_reference_selector_debug},
        {"get_anchor_selector_debug()", debug_handlers::handle_get_anchor_selector_debug},
        {"get_local_to_global_transform_debug()", debug_handlers::handle_get_local_to_global_transform_debug},
        {"get_anchor_event_debug()", debug_handlers::handle_get_anchor_event_debug},
        {"get_anchor_change_debug()", debug_handlers::handle_get_anchor_change_debug},
        ...
        {"set_position_sensorfusion_filtered_global_only(bool:enabled)", debug_handlers::handle_set_position_sensorfusion_filtered_global_only},
